            ...
            <b-card-body class="p-4">
              <b-form @submit.prevent="register()">
                ...
                <b-input-group class="mb-4">
                  ...
                  <b-form-select id="basicSelect" :state="!errors.has('accountType')" name="accountType" v-validate="'required'" :plain="true" v-model="newUser.accountType" :options="['Seller', 'Buyer']">
                  </b-form-select>
                <b-form-invalid-feedback>
